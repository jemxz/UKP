...
function App() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: "30x45 cm glossy finish ceramic wall tiles",
      price: 0.41,
      sqm: 100.00,
      origin: "India",
    ...
    <section id="contact" className="contact">
      <div className="container">
        ...
        <div className="contact-info">
          ...
          <div className="contact-item">
            <h3>Email</h3>
            <p>✉️ contact@djcindustrial.com</p>
          </div>
          <div className="contact-item">
          <h3>Registered Office</h3>
          <p>27, ASHOKA ENCLAVE, SECTOR-2</p>
  ...
  return (
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-section">
          <p>© 2024 	Design Joy Ceramics. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
